...
- The separate analysis/report_labeling_llm_v2/ is a CPU-only NOT RUN candidate. Read its README.md, PROTOCOL.md, RESULTS.md and REVIEW.md. No v2 inference adapter exists yet; adapter tests and tokenizer/template review must precede any paid smoke. Keep both v1 analysis directories and all historical private outputs unchanged. The v2 private review queue has 12 unresolved development items; synthetic tests and ChatGPT advice are not clinical adjudication.
